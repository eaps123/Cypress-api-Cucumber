Feature: Testes automatizados para inclusão de proposta manual simplificado

    # ============================
    # SUCESSO - Cenários mínimos e máximos
    # ============================
    @IncluirPropostaManualSimplificado @Success
    Scenario: Incluir proposta manual simplificado - mínimo aceitável (campos obrigatórios)
        ...
        When eu envio uma requisição POST para proposta ManualSimplificado
            ...
            | VlrTAC                          | 15020.81       |
            | CodigoOperacao                  | {{$guid}}      |
        Then recebo status ManualSimplificado 200
    ...
    # ============================
    @IncluirPropostaManualSimplificado @Edge
    Scenario Outline: Incluir proposta simplificado - casos extremos
        ...
        When eu envio uma requisição POST para proposta ManualSimplificado
            ...
            | VlrSeguroMensal2                | 58.25                  |
            | PercSeguroMensal2               | 0.050                  |
        Then recebo status ManualSimplificado <status_esperado>
    ...
    Scenario Outline: Incluir proposta simplificado - cenários reais
        Given que eu preencha o payload dto da proposta com ManualSimplificado:
        And defina parametros ManualSimplificado:
    ...
    Scenario Outline: Registrar request e response após inclusão PIX bem sucedida
        ...
        And defina parametros ManualSimplificado:
            ...
            | Proposta_IsentarIOF         | <Proposta_IsentarIOF>         |
        And que eu valide o metodo de pagamento ManualSimplificado:
    ...
    Scenario Outline: Registrar request e response com valores inválidos PIX (<ChavePIX>)
        ...
        When eu envio uma requisição POST para proposta ManualSimplificado
            ...
            | VlrTAC                          | 15020.81       |
            | CodigoOperacao                  | {{$guid}}      |
        Then recebo status ManualSimplificado 400
            | erroEsperado | true |
    ...
    # ============================
    @IncluirPropostaManualSimplificado @Failure
    Scenario Outline: Incluir proposta simplificado - campo obrigatório ausente (<campo_ausente>)
        Given que eu preencha o payload dto da proposta com ManualSimplificado:
        And remova os campos obrigatórios do DTO ManualSimplificado "<campo_ausente>"
        And que eu valide o metodo de pagamento ManualSimplificado:
            | PaymentType | <PaymentType> |
        When eu envio uma requisição POST para proposta ManualSimplificado
        Then recebo status ManualSimplificado 400
        ...
        Examples:
            | PaymentType | campo_ausente             |
            | PIX         | DocumentoCliente          |
            | PIX         | VlrSolicitado             |
            | PIX         | CodigoOperacao            |
            | PIX         | VlrProdutoBem             |
            | PIX         | TipoContrato              |
    ...
    # ============================
    @IncluirPropostaManualSimplificada @Failure
    Scenario Outline: Incluir proposta simplificado - valores inválidos -> erro esperado
        ...
        Then recebo status ManualSimplificado <status_invalido>
            | erroEsperado | true |
