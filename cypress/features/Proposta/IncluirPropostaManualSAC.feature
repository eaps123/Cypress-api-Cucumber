Feature: Testes automatizados para inclusão de proposta manual  SAC

    # ============================
    # SUCESSO - Cenários mínimos
    # ============================
    @IncluirPropostaManualSAC @Success
    Scenario: Incluir proposta manual SAC - mínimo aceitável (campos obrigatórios)
        Given 1que eu preencha o payload "manualSAC":
            | tipoProposta                    | manualSAC      |
        ...
        When 1eu envio uma requisição POST para criação de proposta
            | TipoDeProposta | Proposta Manual SAC |
        Then 1recebo status Proposta 200

    # ============================
    # SUCESSO - Cenários máximos
    # ============================
    @IncluirPropostaManualSAC @Success
    Scenario: Incluir proposta manual SAC - com todos os campos preenchidos
        Given 1que eu preencha o payload "manualSAC":
            | tipoProposta                    | manualSAC              |
            | DocumentoCliente                | 007.031.609-07         |
            | DocumentoParceiroCorrespondente | 358.638.490-45         |
    ...
    # ============================
    # SUCESSO - Casos Extremos
    # ============================
    @IncluirPropostaManualSAC @Edge
    Scenario Outline: Incluir proposta Manual SAC - casos extremos
        Given 1que eu preencha o payload "manualSAC":
            | tipoProposta                    | manualSAC              |
            | Prazo                           | <Prazo>                |
    ...
    # ============================
    @IncluirPropostaManualSAC @Success
    Scenario Outline: Incluir proposta manual SAC - varia TipoIndiceFinanceiro e IOF
        Given 1que eu preencha o payload "manualSAC":
            | tipoProposta                    | manualSAC              |
    ...
    # ============================
    @IncluirPropostaManualSAC @Success
    Scenario Outline: Incluir proposta manual SAC - cenários reais
        Given 1que eu preencha o payload "manualSAC":
            | tipoProposta                    | manualSAC              |
            | DocumentoCliente                | 007.031.609-07         |
            | DocumentoParceiroCorrespondente | 358.638.490-45         |
    ...
    # ============================
    @IncluirPropostaManualSAC @Success
    Scenario Outline: Incluir proposta manual SAC PIX bem sucedida
        Given 1que eu preencha o payload "manualSAC":
            | tipoProposta                    | manualSAC      |
            | DocumentoParceiroCorrespondente | 358.638.490-45 |
            | DocumentoCliente                | 007.031.609-07 |
    ...
    # ============================
    @IncluirPropostaManualSAC @Success
    Scenario Outline: Incluir proposta manual SAC Conta bem sucedida
        Given 1que eu preencha o payload "manualSAC":
            | tipoProposta                    | manualSAC      |
            | DocumentoParceiroCorrespondente | 358.638.490-45 |
            | DocumentoCliente                | 007.031.609-07 |
    ...
    Scenario Outline: Incluir proposta manual SAC com valores inválidos PIX (<ChavePIX>)
        Given 1que eu preencha o payload "manualSAC":
            | tipoProposta                    | manualSAC      |
            | DocumentoParceiroCorrespondente | 358.638.490-45 |
            | DocumentoCliente                | 007.031.609-07 |
    ...
    # ============================
    @IncluirPropostaManualSAC @Failure
    Scenario Outline: Incluir proposta - campo obrigatório ausente (<campo_ausente>)
        ...
        And remova os campos obrigatórios do DTO SAC "<campo_ausente>"
        And que eu valide o metodo de pagamento SAC:
            | PaymentType | <PaymentType> |
        And defina parametros SAC:
        ...
        Examples:
            | campo_ausente    | Proposta_IsentarIOF |
    ...
    # ============================
    @IncluirPropostaManualSAC @Failure
    Scenario Outline: Incluir proposta - valores inválidos -> erro esperado
        Given que eu preencha o payload dto da proposta com SAC:
        And que eu valide o metodo de pagamento SAC:
            | PaymentType | <PaymentType> |
        When eu envio uma requisição POST para proposta SAC
