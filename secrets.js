export function UrlBaseRequests() {
    return `https://bmpteste.moneyp.com.br/api`
}
export function UrlBaseRequestsLocal() {
    return `http://localhost:52576/api`
}
export function UrlBaseRequestsReports() {
    return `https://reports.moneyp.dev.br`
}
